...
with app.app_context():
    ...
    employees = [
        Employee(full_name="Алина Козлова Олеговна", phone="+79991234567", position="Разработчик"),
        Employee(full_name="Иван Иванов Олегович", phone="+79997654321", position="Тестировщик"),
        Employee(full_name="Мария Петрова Олеговна", phone="+79995556677", position="Аналитик"),
        Employee(full_name="Алексей Сидоров Олегович", phone="+79998887766", position="Менеджер проекта"),
        Employee(full_name="Елена Козлова Олеговна", phone="+79993334455", position="Дизайнер"),
        Employee(full_name="Дмитрий Смирнов Олегович", phone="+79996665544", position="Системный администратор"),
        Employee(full_name="Ольга Васильева Олеговна", phone="+79997776655", position="Архитектор ПО"),
        Employee(full_name="Сергей Кузнецов Олегович", phone="+79994445566", position="Разработчик")
    ]
